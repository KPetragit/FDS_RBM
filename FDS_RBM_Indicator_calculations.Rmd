...
*At this step, you should already have main and hhroster datasets structured in a way that will allow you to calculate your indicators as you will be guided in this document. It's not recommended to clear your work space.*
...
hhroster <- read_dta("FDS_PAK_2024_Allrespondents_complete.dta")
...
Petra - it does not find HH11?

Add EVAL=False to only show the chunk in final rmarkdown later
...
table(hhroster$H11)  ##What place did you go first to try to see a health professional or healer?
table(hhroster$H15d) ##Approximately, how long did it take to travel in one direction to that place for your first visit?
...
Petra - it gives this error - ℹ In group 1: `_uuid = "000069c1-619b-4e48-9655-3017a66e9afb"`.
Caused by error:
...
#table() -- Petra add here a table on HHmembersize

#also maybe we can call HH14_cat something else like crowding3
...
##Add here - Thomas tables/or disaggregation tables each for RBM?
...
Note that FDS does not measure access to mental health, psychosocial support, rehabilitative services, palliative care. Moreover, three months is the standard recall period to use for this indicator.However in FDS, 30 days have been used as a recall period. Therefore, the below results can only partially be considered as 2.3 Core Impact Indicator. 
...
Petra - maybe we can give the official name that you have when we calculate the final indicator?
Petra - it seems like health indicators are not here?
...
Petra - as the age enrolment will change; we need to put a note for them to check
primary and secondary school rates - if this is already adjusted a note on how the script can change
...
Petra - how should we title the indicators? We need to make it clearer the title
...
# <span style="color:blue; font-size:28px;"><strong>13.3 Core Outcome Indicator - Partially</strong></span>
...
# <span style="color:blue; font-size:28px;"><strong>14.1 Core Outcome Indicator - Partially</strong></span>
**14.1 Proportion of returnees with legally recognized identity documents or credentials  **
##RBM21401

#Same as for 1.3 - The variables related to identitiy documents or credentials need to be incorporated into the hhroster data set. Once they will be, I can calculate this indicator. 

# <span style="color:blue; font-size:28px;"><strong>16.1 Core Outcome Indicator - Partially</strong></span>
...
# <span style="color:blue; font-size:28px;"><strong>16.2 Core Outcome Indicator - Partially</strong></span>
...
```
```{r}
#Step 2.3: Create a new varibale checking if the household recived any assistance programme from the government
main <- main %>%
