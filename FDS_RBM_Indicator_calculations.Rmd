...
BD01 %in% c(13, 14, 21, 31, 41, 51) & BD01a == 3 ~ 0))%>% #Assigns 2 if other source located elsewere
...
mutate(Improved_dw_Loc = case_when(
BD01 %in% c(11, 12) ~ 1,
BD01 %in% c(13, 14, 21, 31, 41, 51) & BD01a %in% c(1, 2) ~ 1,
BD01 %in% c(13, 14, 21, 31, 41, 51) & BD01a == 3 ~ 0))%>%
mutate(Improved_dw_Loc = labelled(Improved_dw_Loc,
                               labels = c(
                                 "Own dwelling/yard/plot" = 1,
                                 "Elsewhere" = 0
