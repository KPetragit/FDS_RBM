...
roster <- roster %>% 
  mutate(RBM21401 = case_when(
    ...
    ID_VAR == 4 & (ID_09 %in% c(1, 8, 9, 11, 12, 13, 14) & ID_13 %in% c("A","H","I","K","L","M","N","OT")  & Legal_birth_certificate == 2 & Legal_ID_card == 2 & Legal_passport == 2) ~ 0, #Assigns 0 if the person has no primary, secondary and no other legal documents), 
    TRUE ~ NA))
